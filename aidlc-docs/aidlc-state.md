...
| `runtime-reconciliation` | Not started | Unit created from 2026-05-13 Fly runtime strategy-performance review; addresses unmonitorable open paper trades, missing SL/TP/proposal links, balance/position drift, and deployed `/data` repair tooling | Create functional design and implement runtime/tool/dashboard reconciliation in construction plans |
| `proposal-funnel-audit` | Not started | Unit created from 2026-05-13 Fly runtime strategy-performance review; addresses generated-to-opened funnel visibility, post-approval gate accounting, cap diagnostics, and outcome linkage | Create functional design and implement proposal/runtime/dashboard funnel audit in construction plans |
| `cross-account-risk-policy` | Not started | Unit created from 2026-05-13 Fly runtime strategy-performance review; addresses risk-based sizing, cross-account symbol/side caps, stale-position limits, and kill switches | Create functional design and implement risk policy/schema/runtime/dashboard changes in construction plans |
...
| `strategy-tuning` | Not started | Unit created from 2026-05-13 Fly runtime strategy-performance review; addresses RSI family consolidation, mean-reversion regime/exit filters, VCP no-signal diagnostics, ORB/session stale exits, and LLM/default account isolation | Create functional design and implement strategy/account tuning slices in construction plans |
