...
| `consistency-hardening` | In progress | CH-01 (exchange config mode/credential alignment) `97e6d4f`; CH-02 (.py promotion + atomic strategy writes) `d19b308`; CH-03 (sub-account cycle isolation + per-notifier failure callback) `c7c30b7`; CH-04 (StrategyValidationError split) shipped 2026-05-09; spec.md backlog refreshed with 25 anchored slices | Continue with CH-05 (dashboard scope/equity), CH-06–CH-10 P1 slices |
