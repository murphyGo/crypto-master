...
| `consistency-hardening` | In progress | CH-01 (legacy exchange config mode/credential alignment) shipped 2026-05-09 (commit `97e6d4f`); CH-02 (.py promotion + atomic strategy artifact writes) shipped 2026-05-09; spec.md backlog refreshed with 25 anchored slices from the 2026-05-09 five-subagent review | Continue with CH-03 (sub-account cycle isolation + notifier failure visibility), CH-04 (StrategyValidationError split), CH-05 (dashboard scope/equity), CH-06–CH-10 P1 slices |
