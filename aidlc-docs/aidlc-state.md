...
| `runtime-reconciliation` | Not started | Design complete; code-generation queued. Functional-design spec landed 2026-05-13 at `aidlc-docs/construction/runtime-reconciliation/functional-design/spec.md`; addresses unmonitorable open paper trades, missing SL/TP/proposal links, balance/position drift, and deployed `/data` repair tooling. Code-generation blocked on 5 open decisions. | Resolve open decisions, then run code-generation cycle against the staged plan |
| `proposal-funnel-audit` | Not started | Design complete; code-generation queued. Functional-design spec landed 2026-05-13 at `aidlc-docs/construction/proposal-funnel-audit/functional-design/spec.md`; addresses generated-to-opened funnel visibility, post-approval gate accounting, cap diagnostics, and outcome linkage via `final_state` field on proposal records. Code-generation blocked on 5 open decisions. | Resolve open decisions, then run code-generation cycle against the staged plan |
| `cross-account-risk-policy` | Not started | Design complete; code-generation queued. Functional-design spec landed 2026-05-13 at `aidlc-docs/construction/cross-account-risk-policy/functional-design/spec.md`; addresses risk-based sizing, cross-account symbol/side caps, stale-position limits, and kill switches. Code-generation blocked on 7 open decisions. | Resolve open decisions, then run code-generation cycle against the staged plan |
