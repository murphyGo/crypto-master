...
| `consistency-hardening` | In progress | CH-01 `97e6d4f`, CH-02 `d19b308`, CH-03 `c7c30b7`, CH-04 `c108c3c`, CH-05 (dashboard command-center scope + per-sub-account aggregate equity + active-queue caption fix) shipped 2026-05-09; spec.md backlog refreshed with 25 anchored slices | Continue with CH-06 (live fill attribution), CH-07 (live position rehydration), CH-08 (account-scoped exchange routing), CH-09 (multi-TF + robustness reporting), CH-10 (post-incident safety score) |
