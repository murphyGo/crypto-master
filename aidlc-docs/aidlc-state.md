...
| `consistency-hardening` | In progress | CH-01 `97e6d4f`, CH-02 `d19b308`, CH-03 `c7c30b7`, CH-04 `c108c3c`, CH-05 `809638f`, CH-06 (live fill attribution: actual exit price + entry/exit fees on `LiveTrader`) shipped 2026-05-09, CH-07 (live position rehydration from persisted SL/TP + fee state) shipped 2026-05-09, CH-08 (account-scoped exchange routing for scan/stale-quote/monitor/snapshot) shipped 2026-05-09; spec.md backlog extended with CH-26..CH-36 from the 2026-05-09 ten-subagent refactor review (36 anchored slices total) | Continue with CH-09 (multi-TF + robustness reporting), CH-10 (post-incident safety score); new P1 queue: CH-26 (backtest metrics module), CH-27 (sim-loop dedup), CH-28 (paper/live parity), CH-29 (proposal gate envelope), CH-30 (engine bootstrap decomposition), CH-31 (sub-account dual-source removal), CH-32 (atomic write coverage) |
