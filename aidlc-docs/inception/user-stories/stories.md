...
| US-023 | As a trading operator, I can open one command-center view that tells me whether the bot is safe to keep running and where to investigate next. | First screen shows safety band, latest cycle, open exposure, sub-account context, data freshness, notification/correlation/liquidation issues, and strategy-evidence links without raw-file inspection | FR-028 - FR-032, FR-036, FR-039, FR-042 - FR-044, NFR-003, NFR-007, NFR-008 | `dashboard-operator-command-center` |
| US-024 | As a trading risk reviewer, I can classify the current market regime and decide per sub-account whether regime gating applies. | Regime labels are operator-visible, sub-account policy can enable/disable gating, allowed regimes are explicit, and blocked decisions are auditable | FR-045, FR-036, FR-029, FR-031, NFR-003, NFR-007, NFR-008 | `market-regime` |
