...
**Suggested Resolution:**
Sequential cycles — (b) opt-in global caps shipped 2026-05-24; (c-1) stateless kill-switch gates shipped 2026-05-24; (c-2) stateful daily-loss kill switch shipped 2026-05-24, completing DEBT-068(c); (d) operator-freeze RUNTIME READ side shipped 2026-05-24. Next (c-arb) cap arbitration, then (e) stale actions, (f) dashboard exposure panel + operator-freeze toggle WRITE side, and (g) event type. (h) runtime-safety-score integration is smaller and can bundle with (f).
